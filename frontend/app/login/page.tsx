  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (data.username === 'demo' && data.password === 'demo123') {
        ...
        setError('Please use demo/demo123 for the demo');
      }
    } catch (err: any) {
      console.error('Login error:', err);
      setError('Failed to login. Please use demo/demo123 for the demo.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8 animate-gradient-x">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg border-t-4 border-teal-500 transform transition-all duration-500 hover:shadow-2xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-center text-3xl font-extrabold text-gray-900">ExamoBuddy</h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Your Medical Q&A Assistant
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center justify-center mt-4">
            <div className="text-sm">
              <Link href="/register" className="font-medium text-teal-600 hover:text-teal-500 transition-colors duration-150 ease-in-out">
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 text-center text-sm text-gray-600">
            <p>Username: <span className="font-semibold">demo</span></p>
